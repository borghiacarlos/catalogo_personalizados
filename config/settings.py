...
# A SECRET_KEY é lida da variável de ambiente. Em desenvolvimento, usamos uma chave padrão.
# NUNCA use a chave de desenvolvimento em produção!
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-sua-chave-de-desenvolvimento-aqui')

# O modo DEBUG é Falso por padrão. Ele só será True se a variável de ambiente 'DEBUG' for '1'.
...
INSTALLED_APPS = [
    ...
    # App do Whitenoise para servir arquivos estáticos
...
# Usa a URL do banco de dados do Render se estiver disponível.
...
STATIC_URL = 'static/'
# Usado em desenvolvimento para encontrar nossa pasta 'static'
STATICFILES_DIRS = [ BASE_DIR / 'static' ]
# O Whitenoise usará esta pasta para servir os arquivos coletados em produção
STATIC_ROOT = BASE_DIR / 'staticfiles'
# Estratégia de armazenamento de arquivos estáticos para o Whitenoise
